...
def circle_overlap(circ1_centre_x, circ1_centre_y, circ1_radius,
    ...
    if circ1_radius == circ2_radius and circ1_centre_x == circ2_centre_x and circ1_centre_y == circ2_centre_y:
        return 'identical circles'
    
    elif ((circ2_centre_y - circ1_centre_y)**2 + (circ2_centre_x - circ1_centre_x)**2)**(1/2) > (circ1_radius + circ2_radius):
        return 'no overlap'
    
    elif ((circ2_centre_y - circ1_centre_y)**2 + (circ2_centre_x - circ1_centre_x)**2)**(1/2) < (circ1_radius - circ2_radius):
        return 'circle 2 is contained within circle 1'
    
    elif ((circ2_centre_y - circ1_centre_y)**2 + (circ2_centre_x - circ1_centre_x)**2)**(1/2) < (circ2_radius - circ1_radius):
